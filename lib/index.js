...
var BTBLanguage = function BTBLanguage() {
  ...
  var translate = function translate(index, replacement) {
    ...
    //  'key': 'string'
    // }
    var text = language.vocabulary ? language.vocabulary[index] : '';
    var reg;
...
var storeInitiator = function storeInitiator(config) {
  _store["default"].init(config);
};

exports.initiator = storeInitiator;